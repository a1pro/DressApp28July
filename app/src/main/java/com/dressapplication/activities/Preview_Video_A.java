...
import com.dressapplication.Model.FilterType;
import com.dressapplication.R;
import com.dressapplication.adapters.Filter_Adapter;
import com.dressapplication.change.Functions;
import com.dressapplication.utils.MovieWrapperView;
...
public class Preview_Video_A extends AppCompatActivity implements Player.EventListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_preview__video_2);
        select_postion=0;
    ...
    public void Set_Player(String path){
        ...
        DataSource.Factory dataSourceFactory = new DefaultDataSourceFactory(this,
                Util.getUserAgent(this, "DressApp"));
    ...
    public void GotopostScreen(){
        ...
        Intent intent =new Intent(Preview_Video_A.this,VideoDescriptionActivity.class);
        intent.putExtra("galleryvideo","yes");
